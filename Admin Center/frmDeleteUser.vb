...
Public Class frmDeleteUser
    ...
    Private Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        ...
        If myReader.Read() Then
            Dim verify As DialogResult = MessageBox.Show("Are you sure want to delete '" & (CType(myReader("name"), String)) & "' information?",
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        ...
        Dim deleteQuery As String = "DELETE FROM AdminUser WHERE name = '" & txtSearch.Text & "'"

        Dim verify As DialogResult = MessageBox.Show("Are you sure want to delete " & txtSearch.Text & " Information?",
                            "Vefrication", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
        ...
        If verify = DialogResult.Yes Then
            ...
            Else
                ...
                MessageBox.Show("User has deleted", "Vefrication", MessageBoxButtons.OK, MessageBoxIcon.Information)
