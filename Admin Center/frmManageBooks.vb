...
Public Class frmManageBooks
    ...
    Private Sub btnAddBook_Click(sender As Object, e As EventArgs) Handles btnAddBook.Click
        ...
        Dim addBook As New frmAddBook
        addBook.Show()
        Me.Hide()

    End Sub

    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdateBook.Click
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDeleteBook.Click
